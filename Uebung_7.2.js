 // array of stopwords// array of stopwords (( code von https://github.com/stopwords-iso/stopwords-de))
// const url = 'https://kaul.inf.h-brs.de/ccm/we/ws23/resources/assets/Plagiatsresolution.html';


// function fetchjson() {      // mit hilfe von https://www.geeksforgeeks.org/read-json-file-using-javascript/#using-fetch-method
//     fetch('https://raw.githubusercontent.com/stopwords-iso/stopwords-de/master/stopwords-de.json')
//   .then(response => response.json())
//   .then(data => console.log(data))
//   .catch(error => console.error('Error fetching JSON:', error));
// }

//toDO: fetch hat nicht funktioniert, deswegen manuell
